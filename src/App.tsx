  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        databases (MongoDB). Experienced in legacy code migration and modernization, cloud-first
        development on Azure, and CI/CD pipelines with DevOps practices. Skilled in front-end
        development with React, Redux, Angular, and TypeScript. Familiar with React Native for
        mobile development.
      </p>
      <div className="links">
        <a href="https://github.com/BedoyaSan" target="_blank" rel="noreferrer">
          <GitHubIcon /> GitHub
        </a>
        <a href="https://linkedin.com/in/BedoyaSan" target="_blank" rel="noreferrer">
